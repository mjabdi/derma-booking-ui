...
export default class TimeService{
     ...
     static getFirstAvailableDate =  () =>
    {
        ...
        return API.get('/api/derma/time/getfirstavaiabledate');
    }
    ...
    {        
       ...
       return API.get('/api/derma/time/getfullybookeddays');
    }
    ...
    static getTimeSlots = (date) =>
    {
        ...
        return API.get(`/api/derma/time/gettimeslots?date=${date_utc}`);
    }
